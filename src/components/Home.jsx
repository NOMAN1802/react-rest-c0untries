...
import Visit from '../assets/Visit.json'
...
if (navigation.state === 'loading') {
  ...
  return (
    <div className='px-12 flex flex-col items-center justify-between lg:flex-row mx-auto'>
      {/* Text Content */}
      <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
        ...
        <div className='flex flex-col items-center md:flex-row'>
          <Link to='/users' className='btn md:w-auto md:mr-4'>
      ...
      <div className='relative lg:w-1/2 '>
        <div className='w-full lg:w-4/5 lg:ml-auto h-56  sm:h-96'>
          <Lottie animationData={Visit} loop={true} />
        </div>
      </div>
    </div>
  )
